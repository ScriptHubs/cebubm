...
new Swiper('.slides-3', {
  ...
  breakpoints: {
    ...
    1200: {
      slidesPerView: 6, // Adjust this to the number of images you want to show in desktop view
    }
  }
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Add event listener to update active indicator on slide change
  carouselElement.addEventListener('slide.bs.carousel', function (event) {
    var indicators = document.querySelectorAll('#heroCarouselIndicators button');
