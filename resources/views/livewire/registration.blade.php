                ...
                <div class="col-12 col-lg-8 pb-5 h-100 justify-content-center d-flex flex-column">
                    ...
                    @elseif($activePanel === 'membership')
                        <div>
                            ...
                            <div class="form-check">
                                <div class="form-check">
                                    <input wire:model.lazy="selectedMembership" class="form-check-input radio-membership"
                                        type="radio" name="membership_radio" id="mem-flexRadioDefault1"
                                ...
                                <div class="form-check">
                                    <input wire:model.lazy="selectedMembership" class="form-check-input radio-membership"
                                        type="radio" name="membership_radio" id="mem-flexRadioDefault2"
                                ...
                                <div class="form-check">
                                    <input wire:model.lazy="selectedMembership" class="form-check-input radio-membership"
                                        type="radio" name="membership_radio" id="mem-flexRadioDefault3"
                            ...
                            <div class="col-lg-8 col-12">
                                <div class="input-group mb-3">
                                    <input wire:model.lazy='name_last' name="name_last" type="text"
                                        class="form-control no-border" placeholder="Last Name" aria-label="Last Name"
                                        aria-describedby="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-12">
                                <div class="input-group mb-3">
                                    <input wire:model.lazy='name_first' name="name_first" type="text"
                                        class="form-control no-border" placeholder="First Name" aria-label="First Name"
                                        aria-describedby="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-8 col-12">
                                <div class="input-group mb-3">
                                    <input wire:model.lazy='email_address' name="email_address" type="text"
                                        class="form-control no-border" placeholder="Email" aria-label="Last Name"
                                        aria-describedby="">
                                </div>
                            </div>
                    ...
                    @elseif($activePanel === 'sectorBoxoption')
                        <div>
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="Private Business" name="sectorBoxoption"
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="Tech Startup Entrepreneur" name="sectorBoxoption"
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="Investor/Accelerator/Incubator" name="sectorBoxoption"
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="LGU/Government Agency" name="sectorBoxoption"
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="Non-Profit/Civic Organization" name="sectorBoxoption"
                            ...
                            <div class="form-check">
                                <input wire:model.lazy="sectorBoxoption" class="form-check-input checkbox-sector"
                                    type="checkbox" value="Academe/Student" name="sectorBoxoption"
                    ...
                    @elseif($activePanel === 'reference')
                        <div>
                            ...
                            <h6 cla onclick="next_panel();" ss="q-caption">Kindly fill out all fields on the next
                                slides.
                                Thank you!</h5>
                                <br>
                                <div class="form-check">
                                ...
                                <div class="col-lg-8 col-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input wire:model.lazy="reference_text" name="reference_text" type="text"
                                            class="form-control no-border" placeholder="" aria-label="other"
                                            aria-describedby="">
                                    </div>
                                </div>
                                <br>
                    ...
                    @elseif($activePanel === 'expectation')
                        <div>
                            ...
                            <br>
                            <h5>Do you have any expectations, burning questions or topics you look forward to cover
                                during
                                the event? We
                                hope that all participants have a fruitful and engaging experience!</h5>
                            <br>
                            <h6>Please provide questions you want the speaker/s to address during the summit </h6>
                        ...
                        <div>
                            ...
                            <div class="form-check">
                                <input wire:model.lazy='connect' value="Speakers & Exhibitors"
                                    class="form-check-input radio-reference" type="checkbox" name="connect_check"
                                    id="connect-flexRadioDefault1" checked>
                                <label class="form-check-label" for="connect-flexRadioDefault1">
                                    Speakers & Exhibitors
                                </label>
                            </div>
                            <div class="form-check">
                                <input wire:model.lazy='connect' value="Technology Professionals / Tech Talent"
                                    class="form-check-input radio-reference" type="checkbox" name="connect_check"
                                    id="connect-flexRadioDefault2">
                            ...
                            <div class="form-check">
                                <input wire:model.lazy='connect' value="Investors/Advisors/Mentors"
                                    class="form-check-input radio-reference" type="checkbox" name="connect_check"
                                    id="connect-flexRadioDefault4">
                                <label class="form-check-label" for="connect-flexRadioDefault4">
                                    Investors/Advisors/Mentors
                                </label>
                            </div>
                            <div class="form-check">
                                <input wire:model.lazy='connect' value="SMEs" class="form-check-input radio-reference"
                                    type="checkbox" name="connect_check" id="connect-flexRadioDefault5">
                    ...
                    <div id="final-window"  class="">
                        ...
                        <h6>YOUR TICKET includes FULL ACCESS to plenary talks and panel discussions at the main stage, the tech expo and
                            networking areas with LUNCH MEAL per day. </h6>
                        <br>
                        <h5>Limited Seats Available on a First Come First Served Basis. </h5>
                        <h6>You will receive an email with payment link from the team. Kindly settle payment within 48 hours to confirm
                            your seat.</h6>
                        <br>
                        <h6>Thank you.</h6>
                        <br>
                        ...
                        <br>
                        <button id="paymentWindowOpen" wire:click='saveGuest' type="button" class="btn btn-orange trigger-enter text-white fs-4">Proceed to Payment</button>
                    </div>
                    @endif
                    <div id="thank-you-panel" class="col-12 col-lg-8 pb-5 h-100 justify-content-center d-flex flex-column  hidden ">
                        <div  class="">
